...
/**
 * SecurityConfig — Minimal security for product-service.
 *
 * <p>All JWT validation is handled by the API Gateway. This service trusts
 * the gateway-injected headers (X-User-Name, X-User-Roles) verified via
 * the InternalSecurityFilter. No CORS needed — the gateway handles it.
 */
@Configuration
@EnableWebSecurity
