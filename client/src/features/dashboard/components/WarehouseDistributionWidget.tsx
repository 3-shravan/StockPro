    ...
    <Card className="rounded-[2.5rem] border border-border/60 bg-card/40 backdrop-blur-xl shadow-sm overflow-hidden flex flex-col group relative">
      <CardHeader className="bg-card/40 border-b border-border/10 p-5 pb-2 relative text-left">
        <div className="flex items-center gap-6 relative">
          ...
          <div>
            <CardTitle className="text-lg md:text-2xl font-black tracking-tighter text-foreground">Location Capacity</CardTitle>
            <CardDescription className="text-[10px] font-black text-foreground/50 uppercase tracking-widest mt-1 text-left">Storage Usage Overview</CardDescription>
          </div>
        </div>
      </CardHeader>
          ...
          <Table className="table-fixed w-full">
            <TableHeader>
              <TableRow className="hover:bg-transparent border-b border-border/40 h-12">
                <TableHead className="px-5 font-black text-xs text-foreground/40 uppercase tracking-widest w-[40%]">Location Name</TableHead>
                <TableHead className="px-5 font-black text-xs text-foreground/40 uppercase tracking-widest text-center w-[30%]">Storage Used</TableHead>
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="px-4 md:px-6 py-4">
                        <div className="flex flex-col gap-3.5">
                          <div className="flex justify-between items-center text-xs font-black uppercase tracking-wide text-foreground/80">
                            ...
                            <span className={cn(percent > 80 ? "text-status-error" : "text-primary")}>{percent}%</span>
                          </div>
                          <div className="w-full h-2.5 bg-foreground/10 dark:bg-white/10 rounded-full overflow-hidden border border-foreground/10 dark:border-white/10 shadow-inner">
                            <div
                              className={cn(
                                ...
                                percent > 80
                                  ? "bg-gradient-to-r from-status-error/80 to-status-error/90 shadow-status-error/30"
                      ...
                      <TableCell className="px-4 md:px-6 py-6 text-right hidden md:table-cell">
                        ...
                        <p className="text-[10px] font-black text-foreground/40 uppercase tracking-wide mt-2">Stored Units</p>
                      </TableCell>
                    </TableRow>
                  );
                })
